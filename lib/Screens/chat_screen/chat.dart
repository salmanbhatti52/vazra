                                    ...
                                    leading: Container(
                                      ...
                                      child: IconButton(
                                        icon: Icon(
                                          Icons.arrow_back_ios,
                                          size: 20,
                                          color: changeTextColorBasedOnBgColorAdvanced(
                                              Thm.isDarktheme(widget.prefs)
                                                  ? fiberchatAPPBARcolorDarkMode
                                                  : fiberchatAPPBARcolorLightMode),
                                        ),
                                                    ...
                                                    children: [
                                                      IsShowUserFullNameAsSavedInYourContacts ==
                                                              ...
                                                              builder: (BuildContext
                                                                ...
                                                                if (snapshot
                                                                  ...
                                                                  return Text(
                                                                    ...
                                                                    maxLines: 1,
                                                                    style: TextStyle(
                                                                        color: changeTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs)
                                                                            ? fiberchatAPPBARcolorDarkMode
                                                                            : fiberchatAPPBARcolorLightMode),
                                                                        fontSize:
                                                                            17.0,
                                                                ...
                                                                return Text(
                                                                  ...
                                                                  maxLines: 1,
                                                                  style: TextStyle(
                                                                      color: changeTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget
                                                                              .prefs)
                                                                          ? fiberchatAPPBARcolorDarkMode
                                                                          : fiberchatAPPBARcolorLightMode),
                                                                      fontSize:
                                                          ...
                                                          : Text(
                                                              ...
                                                              maxLines: 1,
                                                              style: TextStyle(
                                                                  color: changeTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(
                                                                          widget
                                                                              .prefs)
                                                                      ? fiberchatAPPBARcolorDarkMode
                                                                      : fiberchatAPPBARcolorLightMode),
                                                ...
                                                chatId != null
                                                    ? Text(
                                                        getPeerStatus(peer![
                                                            Dbkeys.lastSeen]),
                                                        style: TextStyle(
                                                            color: changeTextColorBasedOnBgColorAdvanced(Thm
                                                                        .isDarktheme(widget
                                                                            .prefs)
                                                                    ? fiberchatAPPBARcolorDarkMode
                                                                    : fiberchatAPPBARcolorLightMode)
                                                  ...
                                                  icon: Icon(
                                                    ...
                                                    color: Thm.isDarktheme(
                                                        ...
                                                        : fiberchatAPPBARcolorLightMode ==
                                                                Colors.white
                                                            ? fiberchatPRIMARYcolor
                                                            : changeTextColorBasedOnBgColorAdvanced(
                                                                fiberchatAPPBARcolorLightMode),
                                                  ),
                                                  onPressed: observer
                                                              .iscallsallowed ==
